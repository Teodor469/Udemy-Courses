...
$format_salary = fn($salary) => '$' . number_format($salary, 2);
...
function calculateAverageSalary($listings, $format_salary)
{
  $totalSalary = 0;
  ...
  return $format_salary($averageSalary);
}
?>
...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    <div class="bg-green-100 rounded-lg shadow-md p-6 my-6">
      <h2 class="text-2xl font-semibold mb-4">Average Salary: <?= calculateAverageSalary($listings, $format_salary)  ?></h2>
    </div>
    <!-- Output -->
