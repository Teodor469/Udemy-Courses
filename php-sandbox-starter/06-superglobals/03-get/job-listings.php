...
$valid_locations = ['Chicago', 'San Francisco', 'New York', 'Seattle', 'Boston'];
...
if(isset($_GET['location']) && in_array($_GET['location'], $valid_locations)) {
  $location = $_GET['location'];

  $filtered_listings = filterListingsByLocation($listings, $location);
} else {
...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    ...
    <!-- Output -->
    <?php foreach ($filtered_listings as $index => $job) : ?>
      <div class="md my-4">
